...
/**
 * Include any settings.*.php file in the current site directory.
 */
foreach (glob(conf_path() . '/settings.*.php') as $filename) {
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_eventsnew_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_eventsnew_dd.inc';
}
// </DDSETTINGS>
